...
const Camera = () => {
  ...
  return (
    <>
      ...
      <View style={[styles.containerfull, styles.container3]}></View>
      ...
      <View style={[styles.containerfull, styles.container4]}>
        <View style={styles.foter}>
          <Image
            source={{
              uri: 'https://img.icons8.com/ios/50/000000/google-mobile.png',
            }}
            style={styles.iconos}></Image>
          <Image
            source={{
              uri: 'https://img.icons8.com/windows/50/000000/santa.png',
            }}
            style={styles.iconos}></Image>
          <Image
            source={{
              uri: 'https://img.icons8.com/ios/50/000000/guest-male.png',
            }}
            style={styles.iconos}></Image>
        </View>
        <View style={styles.foter}>
